...
ATAC_ce11 <- readRDS(url(
    'http://ahringerlab.com/VplotR/ATAC_ce11_Serizay2020.rds'
))
lengths(ATAC_ce11)
```
...
MNase_sacCer3 <- readRDS(url(
    'http://ahringerlab.com/VplotR/MNase_sacCer3_Henikoff2011.rds'
))
...
ATAC_hg38 <- readRDS(url(
    'http://ahringerlab.com/VplotR/ATAC_hg38_Corces2017.rds'
)) %>% GRangesList() %>% unlist() 
```
...
![](://raw.githubusercontent.com/js2264/VplotR/master/man/figures/CTCF_ATAC_hg38_Chen2018_footprint.png)
